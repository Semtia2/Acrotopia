...
(function($){
    ...
    $.fn.autoResize = function(options) {
        ...
        this.filter('textarea').each(function(){
			...
			if (settings.extraSpace > 0) {
				textarea.height(origHeight + settings.extraSpace);
				origHeight = origHeight + settings.extraSpace
			}
			lastScrollTop = null,
			updateSize = function() {
				...
				var scrollTop = Math.max(clone.scrollTop() + settings.extraSpace, origHeight),
